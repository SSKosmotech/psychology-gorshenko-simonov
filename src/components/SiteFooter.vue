            ...
            <div class="footer_upper_line">
                ...
                <div class="wrap_foot_menu">
                    ...
                    <nav class="footer_menu_first">
                        <ul itemscope itemtype="http://schema.org/SiteNavigationElement">
                            ...
                            <li>
                                <router-link to="/payment" itemprop="url">
                                    Оплата
                ...
                <div class="wrap_soc_menu">
                    <nav class="footer_menu_third">
                        <ul itemscope itemtype="http://schema.org/SiteNavigationElement">
                            <li><router-link to="/services" itemprop="url">Сімейний психотерапевт</router-link></li>
                            <li><router-link to="/services" itemprop="url">Дитячий психотерапевт</router-link></li>
                            <li><router-link to="/services" itemprop="url">Індивідуальні заняття</router-link></li>
                        </ul>
                    </nav> 
