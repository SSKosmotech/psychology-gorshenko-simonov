            ...
            <div class="footer_upper_line">
                ...
                <div class="wrap_soc_menu">
                    <nav class="footer_menu_third">
                        <ul itemscope itemtype="http://schema.org/SiteNavigationElement">
                            <li><router-link to="/services">Сімейний психотерапевт</router-link></li>
                            <li><router-link to="/services">Дитячий психотерапевт</router-link></li>
                            <li><router-link to="/services">Індивідуальні заняття</router-link></li>
                        </ul>
                    </nav> 
